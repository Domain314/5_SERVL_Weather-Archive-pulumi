...
import Logo from "../assets/img/logo/snowflake.png"
...
function Footer({ }) {
    ...
    return (
        <footer className="debug-3">
            ...
            <span className="block text-sm text-[#1A1A1A] dark:text-[#eff7f6] sm:text-center">© 2024 <a href="#" className="hover:underline">Weather Archive</a>. All Rights Reserved.
            </span>
